...
public class PaymentMethodsController : ControllerBase
{
    ...
    public PaymentMethodsController(IFactoryLogic factory)
    {
        _factory = factory;
    }
    ...
    public async Task<IActionResult> Get()
    {
        ...
        var (_, service) = _factory.CreatePaymentMethodModule(tenant);
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Put(int id, [FromBody] UpdatePaymentMethodDto dto)
    {
        var tenant = HttpContext.Items["Tenant"]?.ToString() ?? string.Empty;
        var (_, service) = _factory.CreatePaymentMethodModule(tenant);
