...
import { SingleCardComponent } from './shared/layouts';
...
@Component({
  ...
  `],
  standalone: true,  // Establecemos el componente como standalone
  imports: [SingleCardComponent, RouterModule]  // Importa los componentes necesarios
})
